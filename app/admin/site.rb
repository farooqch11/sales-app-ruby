...
# end
  ...
  form(:html => { :multipart => true }) do |f|
    f.inputs "Website Information" do
      ...
      f.input :name
      # f.filepicker_field :logo, as: :file ,:label => "Website Logo",:hint => "Ideal size for logo is : 398 X 162" , class: "btn btn-default",data: { fp_crop_ratio: "*/4", fp_button_class: 'btn btn-default file-pick-btn',fp_button_text: 'Upload'}
